...
for index,row in email_list.iterrows():
    ...
    if any(ele in row[email].lower() for ele in accepted_declines):
        continue
    elif (suggestion):
...
print("Correct emails in correct.csv")
print("Incorrect emails and their suggested fixes in incorrect.csv")
